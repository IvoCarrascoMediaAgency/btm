      ...
      'C2':{
         items:{
            ...
            'I1':{
                ...
                price:119.99,
                qty:0,
                img:'img/botmaster-precio-whatsapp-masivo-mensual-pro.webp',
      
                detalles:'<div class="contenedor-preguntas"><div class="contenedor-pregunta"><p class="pregunta">Ver detalles <span class="icon-negocio"></span></p><ul class="features"><li><i></i> <span class="masc">20 Licencias</span></li><li><i></i>Demos ilimitadas</li><li><i class="fas fa-stop-circle"></i>Comisiones 100%</li></ul></div></div>',
                linkpago:'https://ppls.me/f6pe1O7RAudkALbbQiOw',
                },
            ...
            'I2':{
                ...
                price:299.99,
                qty:0,
                img:'img/botmaster-precio-whatsapp-masivo-anual-pro.webp',
                ...
                linkpago:'https://ppls.me/08gg3KqkBk1F6YpJ8vEg',
                },
            ...
            'I3':{
                ...
                price:399.99,
                qty:0,
                img:'img/botmaster-licencia-white-label-whatsapp-masivo.webp',
                ...
                linkpago:'https://ppls.me/hET0lf3FrwF4qksv62dA',
                },
...
// })
  ...
  var whatsapp_number ="&text=*Orden exitosa*" + "%0A"+"*BotMaster-2022*"+ "%0A"+"✅ *Detalle de la orden:*"+"%0A"+"_Orden N°_"+"%20"+ "%20"+"---"+"%20"+orden+"%20"+"---"+ "%0A"+"_________________________" + "%0A"+mostrarpedidof+ "%0A"+"*Total:*"+ "%20"+ "$"+`${(Number(delivery) + Number(totalfp.toFixed(2))).toFixed(2)}`+ "%0A"+"_________________________"+ "%0A"+'*🙂Datos del Cliente:*'+ "%0A"+mostrarfac+"%20"+mostrarcedula+nombre+email+whatsapp+"%20"+"_________________________" +"%0A"+ retornapagos+cambio+"%0A"+fanlink+ "%20"+"%0A"+"*Total:*"+ "%20"+"$"+`${(Number(delivery) + Number(totalfp.toFixed(2))).toFixed(2)}`+"%0A"+"%0A"+"*Orden N°:*"+ "%20"+orden;
...
//   })
  ...
  var whatsapp_number ="&text=*BotMaster™*" + "%0A"+"✅ _Solicitud Aprobada Prueba N°:_"+ "%20"+orden + "%0A"+"_________________________" + "%0A"+"%0A"+ "*😃 Nombre:*" +"%0A" + nombre + "%20" +"%0A"+"%0A" +"*💼 Nombre del Negocio:*" +"%0A" + nombrenegocio +  "%20" + "%0A"+"%0A"+"*🛒 Tipo de Negocio:*"+"%0A" + tipodenegocio + "%20" + "%0A"+"_________________________" + "%0A"+"%0A"+ "*Un especialista se contactará de inmediato para realizar la prueba.*"+ "%0A"+ "%0A"+"*P.D.*"+ "%20"+ "Guarda nuestro contacto como *BotMaster* para recibir toda la información😉👍";
  ...
  {"nombrePais":"Zimbabue","codPais":"ZW"}
      ...
      function getOfertaTop(country) {
       ...
       return numero+" "+"Emprendedores"+" "  + "de" +" "+ nomPais + "";
      } 
